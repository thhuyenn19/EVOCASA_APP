...
public class SuggestedProductAdapter extends RecyclerView.Adapter<SuggestedProductAdapter.SuggestedProductViewHolder> {
    ...
    private void checkWishlistStatus(String customerId, String productId, SuggestedProductViewHolder holder) {
    ...
    private void toggleWishlist(String customerId, String productId, SuggestedProductViewHolder holder) {
        db.collection("Wishlist")
                .whereEqualTo("Customer_id", customerId)
                .get()
                .addOnSuccessListener(querySnapshot -> {
    ...
    private void createWishlistAndAddProduct(String customerId, String productId, SuggestedProductViewHolder holder) {
    ...
    private void removeProductFromWishlist(String wishlistId, String productId, SuggestedProductViewHolder holder) {
        db.collection("Wishlist").document(wishlistId)
                .get()
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
